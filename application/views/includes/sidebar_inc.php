        ...
        <ul class="list-generos">
            ...
            <li><a href="<?=site_url('/search/index/genero/'.$row['genero_id']);?>"><img src="images/item.png" alt="" class="item-img" /><span class="item"><?=$row['name']. '&nbsp;&nbsp;('. $row['count_recitales'] .')';?></span></a></li>
            <?php }?>
        </ul>
