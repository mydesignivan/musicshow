...
--
-- Servidor: localhost
-- Tiempo de generación: 23-08-2010 a las 04:36:43
...
CREATE TABLE IF NOT EXISTS `bandas` (
  ...
  `influencias` text NOT NULL,
  `discografica_visible` int(1) NOT NULL DEFAULT '0',
  `discografica_actual` varchar(200) NOT NULL,
  `history` text NOT NULL,
  `tocando_desde` char(10) NOT NULL,
  `manager_visible` int(1) NOT NULL DEFAULT '0',
  `manager_name` varchar(200) NOT NULL,
  `manager_phone` char(50) NOT NULL,
...
--
-- Estructura de tabla para la tabla `bandas_linksinteres`
--

DROP TABLE IF EXISTS `bandas_linksinteres`;
CREATE TABLE IF NOT EXISTS `bandas_linksinteres` (
  `linkinteres_id` int(11) NOT NULL AUTO_INCREMENT,
  `bandas_id` int(11) NOT NULL,
  `title` varchar(255) NOT NULL,
  `url` varchar(255) NOT NULL,
  PRIMARY KEY (`linkinteres_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;

--
-- Volcar la base de datos para la tabla `bandas_linksinteres`
--
